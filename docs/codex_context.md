...
├── config/  # 全局配置
│   └── settings.yaml  # 配置示例
├── data_cache/  # 本地缓存与 SQLite 数据库
│   ├── market_data.sqlite  # 行情缓存数据库
│   ├── stock_sh-600519_2023-01-01_2024-12-31_d.csv  # 单股日线缓存
│   └── stock_sh-600519_2024-01-01_2024-12-31_d.csv  # 单股日线缓存
├── docs/  # 项目文档
│   ├── api_reference.md  # 自动生成的 API 参考
...
│   ├── market_data.sqlite  # Notebook 内数据库占位
│   └── 测试.ipynb  # 临时测试笔记本
├── quant_system/  # 核心量化系统代码
│   ├── backtest/  # 回测引擎
│   │   ├── __pycache__/  # 回测模块编译缓存
│   │   │   ├── __init__.cpython-310.pyc  # 编译缓存
│   │   │   ├── __init__.cpython-313.pyc  # 编译缓存
│   │   │   ├── engine.cpython-310.pyc  # 编译缓存
│   │   │   ├── engine.cpython-313.pyc  # 编译缓存
│   │   │   ├── performance.cpython-310.pyc  # 编译缓存
│   │   │   └── performance.cpython-313.pyc  # 编译缓存
│   │   ├── __init__.py  # 回测包初始化
│   │   ├── engine.py  # 单标的日线回测
│   │   └── performance.py  # 绩效统计
│   ├── data/  # 数据获取与存储
...
│   │   │   ├── __init__.cpython-310.pyc  # 编译缓存
│   │   │   ├── __init__.cpython-313.pyc  # 编译缓存
│   │   │   ├── fetcher.cpython-310.pyc  # 编译缓存
│   │   │   ├── fetcher.cpython-313.pyc  # 编译缓存
│   │   │   ├── storage.cpython-310.pyc  # 编译缓存
│   │   │   └── storage.cpython-313.pyc  # 编译缓存
│   │   ├── __init__.py  # 数据包初始化
│   │   ├── fetcher.py  # 数据拉取与缓存
│   │   └── storage.py  # CSV/SQLite 存储
│   ├── indicators/  # 技术指标引擎
│   │   ├── plugins/  # 指标插件
│   │   │   ├── __pycache__/  # 指标插件编译缓存
│   │   │   │   ├── __init__.cpython-310.pyc  # 编译缓存
│   │   │   │   ├── __init__.cpython-313.pyc  # 编译缓存
│   │   │   │   ├── macd.cpython-310.pyc  # 编译缓存
│   │   │   │   ├── macd.cpython-313.pyc  # 编译缓存
│   │   │   │   ├── moving_average.cpython-310.pyc  # 编译缓存
│   │   │   │   ├── moving_average.cpython-313.pyc  # 编译缓存
│   │   │   │   ├── rsi.cpython-310.pyc  # 编译缓存
│   │   │   │   ├── rsi.cpython-313.pyc  # 编译缓存
│   │   │   │   ├── ultimate_features.cpython-310.pyc  # 编译缓存
│   │   │   │   └── ultimate_features.cpython-313.pyc  # 编译缓存
│   │   │   ├── __init__.py  # 指标插件注册
│   │   │   ├── macd.py  # MACD 指标
...
│   │   │   ├── __init__.cpython-310.pyc  # 编译缓存
│   │   │   ├── __init__.cpython-313.pyc  # 编译缓存
│   │   │   ├── base_indicator.cpython-310.pyc  # 编译缓存
│   │   │   ├── base_indicator.cpython-313.pyc  # 编译缓存
│   │   │   ├── engine.cpython-310.pyc  # 编译缓存
│   │   │   └── engine.cpython-313.pyc  # 编译缓存
│   │   ├── __init__.py  # 指标包初始化
│   │   ├── base_indicator.py  # 指标基类
│   │   └── engine.py  # 指标注册与计算入口
│   ├── processing/  # 数据清洗与市场概览
│   │   ├── __pycache__/  # 处理模块编译缓存
│   │   │   ├── __init__.cpython-310.pyc  # 编译缓存
│   │   │   ├── __init__.cpython-313.pyc  # 编译缓存
│   │   │   ├── cleaner.cpython-310.pyc  # 编译缓存
│   │   │   ├── cleaner.cpython-313.pyc  # 编译缓存
│   │   │   ├── industry_sentiment.cpython-310.pyc  # 编译缓存
│   │   │   ├── industry_sentiment.cpython-313.pyc  # 编译缓存
│   │   │   ├── market_view.cpython-310.pyc  # 编译缓存
│   │   │   └── market_view.cpython-313.pyc  # 编译缓存
│   │   ├── __init__.py  # 处理包初始化
│   │   ├── cleaner.py  # 行情清洗标准化
...
│   │   │   │   ├── __init__.cpython-310.pyc  # 编译缓存
│   │   │   │   ├── __init__.cpython-313.pyc  # 编译缓存
│   │   │   │   ├── ma_rsi_long_only.cpython-310.pyc  # 编译缓存
│   │   │   │   └── ma_rsi_long_only.cpython-313.pyc  # 编译缓存
│   │   │   ├── __init__.py  # 策略插件注册
│   │   │   └── ma_rsi_long_only.py  # 均线+RSI 多头策略
│   │   ├── __pycache__/  # 策略模块编译缓存
│   │   │   ├── __init__.cpython-310.pyc  # 编译缓存
│   │   │   ├── __init__.cpython-313.pyc  # 编译缓存
│   │   │   ├── base_strategy.cpython-310.pyc  # 编译缓存
│   │   │   └── base_strategy.cpython-313.pyc  # 编译缓存
│   │   ├── __init__.py  # 策略包初始化
...
│   │   │   ├── __init__.cpython-310.pyc  # 编译缓存
│   │   │   ├── __init__.cpython-313.pyc  # 编译缓存
│   │   │   ├── plotting.cpython-310.pyc  # 编译缓存
│   │   │   └── plotting.cpython-313.pyc  # 编译缓存
│   │   ├── __init__.py  # 可视化包初始化
│   │   └── plotting.py  # 绘图占位
│   ├── __pycache__/  # 包级编译缓存
│   │   ├── __init__.cpython-310.pyc  # 编译缓存
...
│   ├── test_indicators_basic.py  # 指标测试
│   ├── update_codex_directory_structure.py  # 旧版目录更新脚本
│   ├── update_daily_data.py  # 更新日线数据
│   ├── update_directory_structure.py  # 自动更新目录树
...
│   │   ├── views/  # 业务页面
│   │   │   ├── Backtest.vue  # 回测页
│   │   │   ├── IndustrySentiment.vue  # 行业情绪页
│   │   │   ├── MarketOverview.vue  # 市场概览页
│   │   │   └── StockSearch.vue  # 股票搜索页
│   │   ├── App.vue  # 应用根组件
│   │   ├── main.js  # 前端入口
│   │   └── style.css  # 全局样式
│   ├── .gitignore  # 前端忽略配置
